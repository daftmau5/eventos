...
<body>
    <div id="wrapper">
        ...
        <div id="page-content-wrapper" class="col-md-4">
            ...
            <div class="container-fluid">
                  <div class="wrapper">
					<form class="form-signin" id="formLogin" action="ControllerLogin" method="get">       
					  ...
					  <hr>
					  <button type="submit" class="btn btn-lg btn-primary btn-block" name="cmd" value="login">Login</button>
					</form>	  
				  </div>
            </div>
        </div>
